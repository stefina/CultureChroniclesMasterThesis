...
\subsubsection{node-rest-client}
...
\subsubsection{nodebrainz und coverart}

\subsubsection{node-imdb-api}
...
\section{Detailliert}
Im Folgenden werden einzelne Besonderheiten, die in der Implementierung eine Rolle spielen, erläutert.

\subsection{SuggestionItem}
