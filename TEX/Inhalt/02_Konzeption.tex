...
% \paragraph{UserCaseName} UseCaseBeschreibung
% \begin{enumerate}[a.]
% 	\item VarianteA
% 		\begin{enumerate}[1.]
% 			\item VarianteASchritt1
% 			\item VarianteASchritt2
% 		\end{enumerate}
% 	\item VarianteB
% 		\begin{enumerate}[1.]
% 			\item VarianteBSchritt1
% 			\item VarianteBSchritt2
% 		\end{enumerate}
% \end{enumerate}
...
\begin{enumerate}[1.]
	\item User gibt \glqq Terroranschläge Twin Tower\grqq \ in das Suchfeld ein
	\item User grenzt die Suche nach Medientyp \textbf{Video} ein
	\item System sucht nach Items, die zum Suchbegriff passen und sich in einen Zeitraum übersetzen lassen
	\item User wählt den passenden Zeitraum durch die Auswahl des Items \glqq Ereignis - 11. September 2001\grqq \ aus
...
\begin{enumerate}[1.]
	\item User gibt \glqq Der Pate\grqq \ in das Suchfeld ein
	\item User grenzt die Suche nach Medientyp \textbf{Audio} und Medienart \textbf{Musik} ein
	\item System sucht nach Items, die zum Suchbegriff passen und sich in einen Zeitraum übersetzen lassen
	\item User wählt den passenden Zeitraum durch die Auswahl des Items \glqq Film - Der Pate - 1972\grqq \ aus
